    ...
    return (
        <div className="grid lg:grid-cols-2 gap-8 max-w-4xl mx-auto p-4 md:p-0">
            <div className="lg:col-span-2 bg-surface-highlight border border-border rounded-2xl p-4 flex gap-4 items-start shadow-sm">
                <div className="p-2 bg-surface-card text-action rounded-xl flex-none border border-border/50">
            ...
            <div className="space-y-6">
                <ClinicalCard title="Input Dose">
                    <div className="bg-surface-highlight p-4 rounded-2xl border border-border shadow-inner mb-4">
                        <div className="flex items-center justify-between mb-2">
                            <div>
                                <span className="block text-2xl font-black text-text-primary italic tracking-tight">Total 24-Hour Dose</span>
                                <div className="flex items-center gap-1.5">
                                    <div className="w-2 h-2 rounded-full bg-danger animate-pulse"></div>
                                    <span className="text-[10px] text-text-tertiary font-extrabold uppercase tracking-widest">Morphine IV Equivalents</span>
                                </div>
                            </div>
                            <div className="flex items-baseline gap-2 relative">
                                <input
                                    ...
                                    className="w-32 text-4xl font-black text-right text-action border-b-2 border-action/30 focus:border-action outline-none bg-transparent pb-1 transition-all"
                                />
                                <span className="text-sm font-black text-text-tertiary italic">mg/24h</span>
                            </div>
                        </div>
                    </div>
                    ...
                    {showInfusion && (
                        <div className="mb-6 bg-surface-card p-3 rounded-2xl border border-border animate-fade-in">
                    ...
                    <div className="bg-surface-highlight p-4 rounded-xl border border-border">
                        <div className="flex justify-between items-center mb-3">
                            <span className="text-xs font-bold text-text-secondary uppercase">Cross-Tolerance Reduction</span>
                            <div className="min-w-[3.5rem] text-center px-2 py-0.5 rounded-xl bg-surface-card border border-border shadow-sm">
                        ...
                        <div className="mb-4">
                            <div className="flex justify-between gap-2 mb-4">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 py-2 px-1 rounded-xl border transition-all flex flex-col items-center justify-center ${reduction === opt.val
                            ...
                            <div className="px-1">
                                <input
                                    ...
                                    className="w-full h-2 bg-surface-base rounded-2xl appearance-none cursor-pointer accent-action"
                                />
                        ...
                        <div className="text-[11px] leading-relaxed text-text-secondary bg-surface-card p-3 rounded-xl border border-border flex gap-3">
                ...
                <div className="bg-action-bg p-4 rounded-xl border border-action-border/30 flex gap-3 text-action">
            ...
            <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <ClinicalCard className="flex justify-between items-center p-4">
                            ...
                            <div className="text-right">
                                ...
                                <div className="text-[10px] text-text-tertiary line-through opacity-60 mt-1 block">{convert(0.15).raw} raw</div>
                            </div>
                        </ClinicalCard>
                        <ClinicalCard className="flex justify-between items-center p-4">
                            <div>
                ...
                <div>
                    ...
                    {/* Safety Interstitial */}
                    <div className="bg-surface-card rounded-2xl border border-warning/30 overflow-hidden shadow-sm">
                        ...
                        {showSafetyCheck ? (
                            <div className="p-4 space-y-4 animate-fade-in">
                                ...
                                <div className="flex flex-col gap-2 pb-4 border-b border-border">
                                    ...
                                    <div className="text-[10px] bg-warning-bg text-warning p-2 rounded-xl border border-warning/20 leading-relaxed">
